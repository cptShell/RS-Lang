...
import { ANSWERED_AUDIOCALL, END_AUDIOCALL, NEXT_QUESTION_AUDIOCALL, RESET_AUDIOCALL, SET_DATA_USER, START_AUDIOCALL } from '../constants';
...
export type ActionResetAudiocallGame = { type: typeof RESET_AUDIOCALL; payload: {startGame: boolean, endGame: boolean, answered: boolean, counter: number} };
...
export type ActionAudiocallGame = ActionStartAudiocallGame | ActionResetAudiocallGame | ActionNextQuestionAudiocallGame | ActionEndAudiocallGame | ActionAnsweredAudiocallGame;